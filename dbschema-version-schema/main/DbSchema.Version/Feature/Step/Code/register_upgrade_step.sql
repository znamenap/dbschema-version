create procedure [schema_version].[register_upgrade_step]
...
begin
    ...
    begin try
        ...
        merge into [schema_version].[step] as dest
            ...
            on dest.[upgrade] = 1 and dest.[schema_name] = src.[schema_name]
            ...
            when not matched by source and dest.upgrade = 1 then
                delete
        ;
    end try
    begin catch
